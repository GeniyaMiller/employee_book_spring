...
public class EmployeeService {
    ...
    public List<Employee> getAllEmployees() {
        return this.employeeMap.values().stream().toList();
    }
    ...
    public Employee getEmployeeMinSalary() {
        return employeeMap.values().stream().min(Comparator.comparingInt(Employee::getSalary)).orElse(null);
    }


    public Employee getEmployeeMaxSalary() {
        return employeeMap.values().stream().max(Comparator.comparingInt(Employee::getSalary)).orElse(null);
    }
